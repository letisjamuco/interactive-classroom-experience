...
| **Narration (optional)**| Intro voice line                 | On start                    | A short welcome message is played once.                   |

### Notes
- All interactions are activated through a short-distance raycast (about 3 meters).  
- A small on-screen text (e.g. “Press E to interact”) appears when near an interactable object.  
